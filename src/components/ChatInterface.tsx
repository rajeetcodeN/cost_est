  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'bot',
      content: 'Welcome to Nosta! I\'m here to help you 24/7 with your product needs.',
      timestamp: new Date(),
    },
    {
      id: '2',
    ...
    <div className="flex flex-col h-full bg-chat-bg">
      ...
      <div className="bg-gradient-to-r from-primary to-primary-dark text-primary-foreground p-4 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-semibold text-lg">Willkommen bei Nosta!</h2>
                        ...
                        <div className="flex flex-wrap gap-3 mt-5">
                          {message.options.map((option, index) => (
                            <Button
                              ...
                              className={`rounded-full text-sm font-medium px-5 py-2.5 transition-all duration-200 border-2 ${
                                option === 'Passfeder' ? 'bg-emerald-50 border-emerald-300 text-emerald-700 hover:bg-emerald-100 hover:shadow-md hover:scale-105' :
